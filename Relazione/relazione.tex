...
\input{Parti/Gerarchia_di_tipi}
\input{Parti/Template_Container}
\input{Parti/Altre_Classi}
\input{Parti/Chiamate_polimorfe}
\input{Parti/Formato_dei_file_di_salvataggio_e_caricamento}
% section descrizione_aspetti_progettuali (end)
\section{Note tecniche} % (fold)
\label{sec:note_tecniche}
\input{Parti/Istruzioni_di_compilazione}
\input{Parti/Ambiente_di_sviluppo}
\input{Parti/Ripartizione_ore}
